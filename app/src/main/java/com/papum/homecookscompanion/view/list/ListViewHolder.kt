...
class ListViewHolder(itemView:View) : ViewHolder(itemView) {
	val tvType:TextView		= itemView.findViewById(R.id.recycler_card_list_item_type)
    val tvName:TextView		= itemView.findViewById(R.id.recycler_card_list_item_text)
